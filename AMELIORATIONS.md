...
- [x] **Mode "Révision du jour"** : session automatique avec uniquement les termes à revoir aujourd'hui
...
- [x] **Courbe de progression** : graphique temporel montrant l'évolution du nombre de termes maîtrisés
...
## 6. UX / UI
- [x] **Animations de feedback** : confettis sur bonne réponse, shake sur erreur
- [ ] **Mode sombre / clair** : toggle de thème
- [ ] **PWA** : installation sur mobile, fonctionnement offline
- [x] **Raccourcis clavier** : 1-4 pour les réponses quiz, espace pour retourner la carte
